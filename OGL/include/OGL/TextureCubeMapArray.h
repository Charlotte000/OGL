...
/**
 * @brief Texture Cubemap Array is used to store cubemap array texture.
 * 
...
public:
     ...
     * @param size Size of the texture in pixels (width and height of each cube face, number of cube map layers). Width and height of each cube face must be the same.
     ...
     * @param image The image to be copied to the texture store. Width and height of each layer must be the same.
     * @param internalFormat Internal format of the texture.
     * @param filter Filter mode of the texture (magnification and minification).
     * @param wrap Wrap mode of the texture (for S, T and R texture coordinates).
     * @throw std::invalid_argument if width and height of each cube face are not the same.
    ...
    TextureCubeMapArray(const TextureCubeMapArray& tex);

    TextureCubeMapArray& operator=(TextureCubeMapArray&& tex);
