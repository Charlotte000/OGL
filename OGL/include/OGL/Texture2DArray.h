...
public:
    /**
     * @brief Construct a new 2D Texture array object
     * @param size Size of the texture in pixels (width, height, depth).
    ...
    /**
     * @brief Construct a new 2D Texture array object from the specified image.
    ...
    Texture2DArray(const Texture2DArray& tex);
