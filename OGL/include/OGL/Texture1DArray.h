...
/**
 * @brief Texture 1D array class is used to store several 1D images with the same internal format and size.
 * 
 * Texture objects are immutable, meaning their size, internal format, filter and wrap modes can not be changed after creation.
 */
class Texture1DArray : public Texture<GL_TEXTURE_1D_ARRAY, 2>
{
public:
