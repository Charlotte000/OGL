...
public:
    /**
     * @brief Construct a new 2D Texture object
     * @param size Size of the texture in pixels (width, height).
    ...
    /**
     * @brief Construct a new 2D Texture object from the specified image.
